...
-- ["\\:","/:","ins:","~:","1:t","2:t","3:w","4:w","5:n","6:i","7:i","8:?","9:tw","0:n","-:mail","=:im","[:twitt","]:music"]
...
-- Dzen startup command
myDzenXmonad="dzen2 -y 0 -x 0 -w 1000 -ta l " ++ myDzenStyle

-- Dzen status monitoring
myDzenMonitoring="~/.dzen/dzen_xmonad.sh"

-- Dzen style
myDzenStyle = "-fg '" ++ myDzenFgColor ++
              "' -bg '" ++ myDzenBgColor ++
              "' -fn '" ++ myDzenFont ++
              "' -h 20"

myDzenFgColor = "#E74C3C"
myDzenBgColor = "#1B1B1B"

myDzenFont = "-ypn-envypn-Medium-R-Normal--13-130-75-75-C-90-ISO8859-1"
