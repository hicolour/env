...
myWorkspaces = [wsGEN,wsPRIV, wsWRK1, wsWRK2, wsIDE, wsSLACK, wsSKYPE, wsTMP]
...
projects =
    ...
    , Project   { projectName       = wsSLACK
                , projectDirectory  = "~/"
                , projectStartHook  = Just $ do spawnOn wsSYS "slack"
                }

    , Project   { projectName       = wsSKYPE
                , projectDirectory  = "~/"
                , projectStartHook  = Just $ do spawnOn wsSYS "skypeforlinux"
                }
...
showKeybindings x = addName "Show Keybindings" $ io $ do
    h <- spawnPipe "zenity --text-info --font=terminus --width=800 --height=600"
